...
export default function CategoryAdd({ route, navigation }){
    ...
    const [categoryDetail, setCategoryDetail] = useState(route.params.categoryDetail);
    ...
    const postData = () => {
      ...
      fetch("https://northwind.vercel.app/api/categories/" + route.params.categoryId, requestOptions)
